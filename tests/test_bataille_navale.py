...
def test_cree_grille_lignes_independantes():
    """
...
def test_cree_grille_size_zero():
    """
    Comportement simple attendu pour size=0 : grille vide.
    """
    assert bn.cree_grille(0) == []

def test_affiche_grille_simple():
    """
    affiche_grille doit imprimer une grille simple.
    """
    grille = [
        ["~", "~"],
        ["~", "~"],
...
def test_affiche_grille_avec_symboles_partie():
    """
